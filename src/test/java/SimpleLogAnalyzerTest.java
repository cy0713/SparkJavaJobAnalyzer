...
public class SimpleLogAnalyzerTest extends AbstractAnalyzerTest{	
	...
	public void testAnalyze(){
		...
		SimpleLogAnalyzer analyticsJob = new SimpleLogAnalyzer();
		 ...
		 */
        executePushdownStorlet(lambdas,"test_data/storlet_output.simpleloganalyzer_pushdown");
		...
		analyticsJob = new SimpleLogAnalyzer();
		//We execute the analytics job on the output of the storlet
